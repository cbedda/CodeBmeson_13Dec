#ifndef ALIANALYSISTASKSEB0toDminuspi_WBCUTS_H
#define ALIANALYSISTASKSEB0toDminuspi_WBCUTS_H
/**************************************************************************
...
class AliAnalysisTaskSEB0toDminuspi_wBcuts : public AliAnalysisTaskSE 
{
  
 public:
  
  AliAnalysisTaskSEB0toDminuspi_wBcuts();
  AliAnalysisTaskSEB0toDminuspi_wBcuts(const Char_t* name, AliRDHFCutsBtoDpluspi* dpluscutsana);
  virtual ~AliAnalysisTaskSEB0toDminuspi_wBcuts();
  ...
  void FillSpectrum(AliAODRecoDecayHF2Prong *Bpart, Int_t Match, Double_t Bz);
 ...
 private:
  ...
  AliAnalysisTaskSEB0toDminuspi_wBcuts(const AliAnalysisTaskSEB0toDminuspi_wBcuts &source);
  AliAnalysisTaskSEB0toDminuspi_wBcuts& operator=(const AliAnalysisTaskSEB0toDminuspi_wBcuts& source); 
  ...
  AliRDHFCutsBtoDpluspi *fRDCutsAnalysis; /// Cuts for Analysis
  // std::vector<AliAODRecoDecayHF2Prong*> fArrayB0; //!<! vector to save B candidate 
 
  // define the histograms
  TH1F *fCEvents;                            //!<!hist. for No. of events
  TH1F *fGeneratedinEtavspT;                 //!<!hist. for No. of B generated in eta vs pT
  TH1F *fGeneratedinYvspT;                 //!<!hist. for No. of B generated in eta vs pT
  TH1F *fGeneratedvspT;                      //!<!hist. for No. of B generated vs pT
  ...
  TH1F* fB0InvMassBinLS[kMaxPtBins];                      //!<!hist. for B0 mass in pT bins LS
  ...
  TH1F* fB0InvMassBin_PassCut1LS[kMaxPtBins];               //!<!hist. for B0 mass after cut in pT bins   LS
  ...
  TH1F* fB0InvMassBinMinusD_PassCut1LS[kMaxPtBins];         //!<!hist. for B0minusD mass after cut in MC in pT bins  LS
  ...
  ClassDef(AliAnalysisTaskSEB0toDminuspi_wBcuts,1); /// class for B spectra
};
